    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 pt-24 max-w-4xl">
            ...
            return (
              <div key={index} className="bg-card rounded-lg sm:rounded-xl p-4 sm:p-6 border border-border">
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="p-1.5 sm:p-2 rounded-lg bg-flame-orange/20 shrink-0">
                    <Icon className="w-4 h-4 sm:w-5 sm:h-5 text-color-secondary" />
                  </div>
                  <div>
                    <h2 className="text-base sm:text-lg md:text-xl font-semibold text-color-secondary mb-2 sm:mb-3">{section.title}</h2>
        ...
        <div className="mt-8 sm:mt-10 md:mt-12 p-4 sm:p-6 bg-card rounded-lg sm:rounded-xl border border-golden/20">
          <h3 className="text-base sm:text-lg font-semibold text-color-secondary mb-2 sm:mb-3">
            {t("customerService" )}
          </h3>
