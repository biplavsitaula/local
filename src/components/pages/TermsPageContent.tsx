        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <div className="flex justify-center mb-3 sm:mb-4">
            <div className="p-2 sm:p-3 rounded-full bg-ternary-text/20">
              <FileText className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-ternary-text" />
            </div>
          </div>
        ...
        <div className="space-y-4 sm:space-y-6">
          {sections.map((section, index) => (
            <div key={index} className="bg-card rounded-lg sm:rounded-xl p-4 sm:p-6 border border-border">
              <h2 className="text-base sm:text-lg md:text-xl font-semibold text-ternary-text mb-2 sm:mb-3">
